...
def SubjectView(page: ft.Page, params: Params, basket: Basket) -> ft.View:
    ...
    async def no_click(e: ft.ControlEvent) -> None:
        await close_dlg(e)

    async def subscribe_dialog(e: ft.ControlEvent):
        dlg.actions = [
            ft.ElevatedButton('Да', on_click=yes_click, bgcolor=ft.colors.GREEN, color=ft.colors.WHITE,
                              height=40),
    ...
    async def unsubscribe_dialog(e: ft.ControlEvent):
        dlg.actions = [
    ...
    async def subscribe_click(e: ft.ControlEvent) -> None:
        await subscribe_dialog(e)

    async def unsubscribe_click(e: ft.ControlEvent) -> None:
        await unsubscribe_dialog(e)
